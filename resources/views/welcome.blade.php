    ...
    <style>
        ...
        *::after {
        ...
        .device[data-device=iPhoneX][data-orientation=portrait][data-color=black]::after {
            content: "";
            background-image: url("/build/assets/portrait_black.png");
        }
...
<body class="antialiased">
    <div>
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            @auth
            <a href="{{ url('/dashboard') }}" class="font-semibold text-blue-500 hover:text-purple-500 dark:text-blue-500 dark:hover:text-purple-500 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
            @else
            <a href="{{ route('login') }}" class="font-semibold text-blue-500 hover:text-purple-500 dark:text-blue-500 dark:hover:text-purple-500 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log in</a>

            @if (Route::has('register'))
            <a href="{{ route('register') }}" class="ml-4 font-semibold text-purple-500 hover:text-blue-500 dark:text-blue-500 dark:hover:text-purple-500 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a>
            @endif
            @endauth
        </div>
        @endif
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        <h1 class="display-1 lh-1 mb-3">Gestor y administrador de muebles y materiales</h1>
                        <p class="lead fw-normal text-muted mb-5">Tener
                            detalle de lo que estás gastando por cada mueble y consulta los materiales y su
                            valor por cada mueble que ya tiene terminado.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="device-wrapper">
                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="screen bg-black">
                                    <img src="\build\assets\mueble.jpg" style="max-width: 100%; height: 100%">
                                    </img>
                                </div>
                            </div>
                        </div>
